...
export function BrakeTemperature() {
  ...
  // Transform data to include all brake temps
  const chartData = telemetryData.map((point) => ({
    distance: point.distance,
    frontLeft: point.brakeTemps.frontLeft,
    frontRight: point.brakeTemps.frontRight,
    rearLeft: point.brakeTemps.rearLeft,
    rearRight: point.brakeTemps.rearRight,
  }));
      ...
      <div className="flex-1 p-4">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
            ...
            />
            <ReferenceLine y={400} stroke="#00d2be" strokeDasharray="5 5" label={{ value: 'Optimal', fill: '#00d2be', fontSize: 10 }} />
            <ReferenceLine y={550} stroke="#e10600" strokeDasharray="5 5" label={{ value: 'Critical', fill: '#e10600', fontSize: 10 }} />
            <Line 
              type="monotone" 
              dataKey="frontLeft" 
              stroke="#ff6b6b" 

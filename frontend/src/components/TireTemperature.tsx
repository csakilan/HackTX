        ...
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
            ...
            <Legend 
              ...
              iconSize={8}
            />
            <ReferenceLine y={90} stroke="#00d2be" strokeDasharray="5 5" label={{ value: 'Optimal', fill: '#00d2be', fontSize: 9, position: 'right' }} />
            <ReferenceLine y={105} stroke="#ffa500" strokeDasharray="5 5" label={{ value: 'Hot', fill: '#ffa500', fontSize: 9, position: 'right' }} />
            <Line 
              type="monotone" 
              dataKey="frontLeft" 
              stroke="#ff6b6b" 
